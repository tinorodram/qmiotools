...
autodoc_mock_imports = ["qiskit", "numpy", "pytket", "scipy", "pandas"]
...
htmlhelp_basename = 'qmiotoolsdoc'
...
latex_documents = [
    ('index', 'qmiotools.tex', 'qmiotols Documentation',
     'CESGA', 'manual'),
]
...
man_pages = [
    ('index', 'qmiotools', 'Qmiotools Documentation',
     ['CESGA'], 1)
]
...
texinfo_documents = [
    ('index', 'qmiotools', 'Qmiotools Documentation',
     'CESGA', 'CESGA', 'One line description of project.',
     'Miscellaneous'),
]
